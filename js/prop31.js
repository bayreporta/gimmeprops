...
function slideNext() {
	if (curSlide == 1) {
		...
		document.getElementById('capitol_s2').style.display = "block";
		curSlide = 2;
	}
	else if (curSlide == 2) {
		document.getElementById('capitol_s2').style.display = "none";
		document.getElementById('governor_s3').style.display = "block";
		curSlide = 3;
	}
	else if (curSlide == 3) {
		document.getElementById('governor_s3').style.display = "none";
		document.getElementById('chamber_s4').style.display = "block";
		curSlide = 4;
	}
	else if (curSlide == 4) {
		document.getElementById('chamber_s4').style.display = "none";
		document.getElementById('rotunda_s5').style.display = "block";
		curSlide = 5;
	}
	else if (curSlide == 5) {
		document.getElementById('rotunda_s5').style.display = "none";
