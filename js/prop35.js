...
function slideNext() {
	...
	/*
		$('#container').css({'position':'relative'});
			$('#summary_slide').css({'position':'absolute', 'left': '-550px'});
			$('#summary_slide *').css({'position':'relative'});
			*/
		...
		document.getElementById('quiz_s3').style.display = "block";
		curSlide = 3;
	}

	else if (curSlide == 3) {
		document.getElementById('quiz_s3').style.display = "none";
